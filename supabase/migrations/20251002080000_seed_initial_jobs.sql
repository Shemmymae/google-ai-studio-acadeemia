/*
  ...
  ## Overview
  This migration populates the jobs table with initial job postings that were previously
  displayed as static content on the careers page. These jobs can now be managed through
  the admin dashboard.
  ...
  ## Important Notes
  1. These are the original mock jobs from the careers page
  2. All jobs are now editable via the admin dashboard
  3. Jobs can be deleted, updated, or new ones can be added
  4. The published_at timestamp is set to the migration time
*/
