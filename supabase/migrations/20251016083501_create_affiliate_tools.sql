/*
  ...
  - `name` (text, not null) - Tool name/title
  - `description` (text, not null) - Short description (max 80 words)
  - `logo_url` (text, not null) - URL to tool logo image
  - `affiliate_link` (text, not null) - Affiliate/external link URL
  - `category` (text) - Tool category (optional grouping)
  - `is_active` (boolean, default true) - Active status for display
  ...
  ## Important Notes
  1. Tools are publicly readable without authentication
  2. Only active tools are displayed on the public page
  3. Display order allows manual sorting of tools
*/
