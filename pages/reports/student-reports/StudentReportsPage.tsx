...
const StudentReportsPage = () => {
  ...
  const mockData = [
    { id: 1, sl: 1, photo: '/api/placeholder/40/40', name: 'Danielle Solomon', gender: 'Male', registerNo: 'RSM-00001', roll: 1, class: 'Six', section: 'A', guardianName: 'Binoya Naik', admissionDate: '25.Mar.2025', mobile: '+254 712 345 678' },
    { id: 2, sl: 2, photo: '/api/placeholder/40/40', name: 'Angelina Jolie', gender: 'Female', registerNo: 'RSM-00002', roll: 2, class: 'Six', section: 'A', guardianName: 'Summer Dixon', admissionDate: '25.Mar.2025', mobile: '+254 712 345 679' },
    { id: 3, sl: 3, photo: '/api/placeholder/40/40', name: 'Mollie Flores', gender: 'Female', registerNo: 'RSM-00003', roll: 3, class: 'Six', section: 'A', guardianName: 'Summer Dixon', admissionDate: '25.Mar.2025', mobile: '+254 712 345 680' },
    { id: 4, sl: 4, photo: '/api/placeholder/40/40', name: 'Gajendra Brahmbhatt', gender: 'Male', registerNo: 'RSM-00009', roll: 4, class: 'Six', section: 'A', guardianName: 'Binoya Naik', admissionDate: '27.Apr.2025', mobile: '+254 712 345 681' }
  ];

  return (
    <DashboardLayout title="Reports - Student Reports">
        ...
        {showResults && (
          <div className="bg-card dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-2 mb-4 pb-4 border-b border-teal-500">
              ...
              <h3 className="text-lg font-semibold text-text-primary dark:text-gray-100">Student Report</h3>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-700 dark:border-gray-600">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-400 dark:text-gray-500">Mobile</th>
                ...
                <tbody>
                  {mockData.map((student) => (
                    <tr key={student.id} className="border-b border-gray-700 dark:border-gray-600 hover:bg-gray-700/50 dark:hover:bg-gray-900/50">
                      ...
                      <td className="py-3 px-4 text-text-secondary dark:text-gray-400">{student.mobile}</td>
