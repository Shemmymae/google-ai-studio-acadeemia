...
const SiblingReportPage = () => {
  ...
  const mockData = [
    { id: 1, sl: 1, photo: '/api/placeholder/40/40', name: 'Danielle Solomon', gender: 'Male', registerNo: 'RSM-00001', roll: 1, class: 'Six', section: 'A', guardianName: 'Binoya Naik', siblings: 'John Solomon (RSM-00015)' },
    { id: 2, sl: 2, photo: '/api/placeholder/40/40', name: 'Angelina Jolie', gender: 'Female', registerNo: 'RSM-00002', roll: 2, class: 'Six', section: 'A', guardianName: 'Summer Dixon', siblings: 'Brad Jolie (RSM-00020)' }
  ];

  return (
    <DashboardLayout title="Reports - Sibling Report">
        ...
        {showResults && (
          <div className="bg-card dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-2 mb-4 pb-4 border-b border-teal-500">
              ...
              <h3 className="text-lg font-semibold text-text-primary dark:text-gray-100">Sibling Report</h3>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-700 dark:border-gray-600">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-400 dark:text-gray-500">Siblings</th>
                  </tr>
                </thead>
                <tbody>
                  {mockData.map((student) => (
                    <tr key={student.id} className="border-b border-gray-700 dark:border-gray-600 hover:bg-gray-700/50 dark:hover:bg-gray-900/50">
                      ...
                      <td className="py-3 px-4 text-text-secondary dark:text-gray-400">{student.siblings}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
...
export default SiblingReportPage;