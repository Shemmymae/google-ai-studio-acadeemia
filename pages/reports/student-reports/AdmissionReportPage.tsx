...
const AdmissionReportPage = () => {
  ...
  const mockData = [
    { id: 1, sl: 1, name: 'Danielle Solomon', gender: 'Male', registerNo: 'RSM-00001', roll: 1, class: 'Six', section: 'A', guardianName: 'Binoya Naik', admissionDate: '25.Mar.2025' },
    { id: 2, sl: 2, name: 'Angelina Jolie', gender: 'Female', registerNo: 'RSM-00002', roll: 2, class: 'Six', section: 'A', guardianName: 'Summer Dixon', admissionDate: '25.Mar.2025' },
    { id: 3, sl: 3, name: 'Mollie Flores', gender: 'Female', registerNo: 'RSM-00003', roll: 3, class: 'Six', section: 'A', guardianName: 'Summer Dixon', admissionDate: '25.Mar.2025' },
    { id: 4, sl: 4, name: 'Gajendra Brahmbhatt', gender: 'Male', registerNo: 'RSM-00009', roll: 4, class: 'Six', section: 'A', guardianName: 'Binoya Naik', admissionDate: '27.Apr.2025' }
  ];

  const totalStudents = mockData.length;
  const dateFrom = '01_Jan.2025';
  const dateTo = '31_Dec.2025';

  return (
    <DashboardLayout title="Reports - Admission Report">
      <div className="space-y-6">
        ...
        {showResults && (
          <div className="bg-card dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-2 mb-6 pb-4 border-b border-teal-500">
              ...
              <h3 className="text-lg font-semibold text-text-primary dark:text-gray-100">Student List</h3>
            </div>

            <div className="bg-gray-700/50 dark:bg-gray-900/50 border-l-4 border-teal-500 p-4 mb-6 rounded">
              <p className="text-text-primary dark:text-gray-200 font-medium">
                Total of {totalStudents} students Admission during this period from {dateFrom} to {dateTo}
              </p>
            </div>
            ...
            <div className="flex justify-between items-center mt-4">
              <div className="text-sm text-text-secondary dark:text-gray-400">
                Showing 1 to {totalStudents} of {totalStudents} entries
              </div>
