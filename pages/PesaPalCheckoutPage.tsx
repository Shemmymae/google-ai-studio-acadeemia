        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8">
                <div className="text-center">
                    <img src="https://www.pesapal.com/images/pesapal_logo.png" alt="PesaPal" className="h-10 mx-auto mb-6" />
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Confirm Your Payment</h2>
                    <p className="text-gray-600 dark:text-gray-400 mt-2">You are paying for the Acadeemia subscription.</p>
                </div>
                ...
                {processing ? (
                    <div className="mt-8 text-center">
                        ...
                        <p className="mt-4 text-gray-600 dark:text-gray-400">Processing your payment securely...</p>
...
export default PesaPalCheckoutPage;
